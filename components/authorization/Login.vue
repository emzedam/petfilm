<template>
    <div class=" lg:col-span-4 col-span-12 dark:bg-stone-900  w-full h-full">
        <div class=" flex items-center justify-end p-6">
            <a href="./index.html"><button class="p-2 bg-yellow-500 rounded-lg"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="#fff"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-left"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l14 0" /><path d="M5 12l6 6" /><path d="M5 12l6 -6" /></svg></button></a>
        </div>
        <div class="flex items-center justify-center lg:mt-20 md:mt-32 mt-20">
            <svg  xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 167.67 54.24" class="w-[180px] flex items-center justify-center">
                <path
        ...
        <div class=" flex items-center justify-center">
            ...
            <span class="text-sm dark:text-stone-300">نام کاربری، پست الکترونیک یا شماره موبایل خود را وارد کنید
        ...
        <div class="flex items-center justify-center mt-2 py-2">
            <form class="relative text-sm border border-slate-200 dark:border-stone-700 rounded-xl">
                     <input class="w-full p-4 pl-32 dark:bg-stone-800 rounded-xl" type="email" placeholder="ایمیل یا شماره موبایل">
 
            <div class="absolute top-3 left-2">
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="#a8a29e"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-device-mobile"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6 5a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2v-14z" /><path d="M11 4h2" /><path d="M12 17v.01" /></svg>
            </div>

            </form>
        </div>
        <div class="flex items-center justify-center py-2 text-xs">
            <h4><span class="text-yellow-500 font-semibold">آیا حساب کاربری ندارید ؟ </span><span class="dark:text-white">ثبت نام کنید</span></h4>
        </div>

        <div class="flex items-center justify-center py-5">
            <button class="bg-yellow-500 lg:px-6 px-4 py-4 rounded-lg hover:bg-yellow-700 font-semibold"><a href="./regaster.html">ورود به پت فیلم</a></button>
        </div>
    </div>
</template>
