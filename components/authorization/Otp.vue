    ...
    <div class="lg:col-span-4 col-span-12 dark:bg-stone-900 p-5 w-full">
        ...
        <div class="flex items-center justify-center  my-5">
            ...
            <div class="flex items-center justify-center gap-3">
               <div class="box">
                <form>
                    <input type="text" class="bg-slate-200 dark:bg-stone-800 lg:px-4  py-4 w-16 h-16 rounded-lg text-center">
                </form>
               </div>
               <div class="box">
                <form>
            ...
            <div class="flex items-center justify-center mt-10">
                <a href="./index.html"><button class="p-4 px-20 rounded-lg bg-yellow-500 hover:bg-yellow-700 font-semibold">تایید حساب</button></a>
            </div>
