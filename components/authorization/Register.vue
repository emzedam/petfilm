<template>
    <div class=" lg:col-span-4 col-span-12 dark:bg-stone-900  w-full h-full">
        ...
        <div class=" flex items-center justify-center">
            ...
            <span class="text-sm dark:text-stone-300">شماره موبایل خود را وارد کنید
        ...
        <div class="flex items-center justify-center mt-2 py-2">
            <form class="relative text-sm border border-slate-200 dark:border-stone-700 rounded-xl">
                    <input class="w-full p-4 pl-32 dark:bg-stone-800 rounded-xl" type="email" placeholder=" شماره موبایل">
        ...
        <div class="flex items-center justify-center py-2 text-xs">
            <h4><span class="text-yellow-500 font-semibold">آیا حساب کاربری دارید ؟ </span><span class="dark:text-white"> وارد شوید </span></h4>
        </div>
