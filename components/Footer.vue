<template>
    <footer class="lg:px-6 mt-10 px-3">
        <div class="grid lg:grid-cols-8 gap-4 p-3">
            <div class="text-white xl:col-span-4 col-span-8 py-10 px-6 rounded-lg bg-slate-50 dark:bg-stone-900">

                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 167.67 54.24" class="w-[120px]">
                    <defs>
            ...
            <div class="dark:text-white xl:col-span-2 lg:col-span-4 py-10 px-6 rounded-lg bg-slate-50 dark:bg-stone-900 hidden lg:block">
                <h3 class=" font-semibold flex items-center justify-center pb-5">اعتماد شما افتخار ماست</h3>
                <div class="flex justify-center items-center relative overflow-hidden w-full pt-3">
                    <div>
                           <img class="w-32 h-32 rounded-lg px-1 object-cover"
                    src="https://img.freepik.com/free-vector/bird-colorful-logo-gradient-vector_343694-1365.jpg?size=338&ext=jpg&ga=GA1.1.2008272138.1724716800&semt=ais_hybrid"
                    alt="">
                    </div>
